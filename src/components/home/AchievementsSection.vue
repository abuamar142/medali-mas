  ...
  >
    ...
    <template #header>
      <div class="text-center">
        <h2
          class="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4 lg:mb-6"
          v-html="achievementsTitle"
        />
    ...
    <div class="relative z-10">
      ...
      <div class="bg-white/10 backdrop-blur-sm rounded-3xl p-8 lg:p-12 border border-white/20">
        <div class="text-center mb-12">
          <h3 class="text-3xl font-bold text-white mb-4">
            {{ $t('achievements.statistics.title') }}
          </h3>
      ...
      <div class="mt-16 text-center">
        <h3 class="text-2xl font-bold text-white mb-6">
          {{ $t('achievements.recognition.title') }}
        </h3>
